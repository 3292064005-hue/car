...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--board-class', default='')
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = {
        ...
        'artifactType': 'real_board_acceptance',
        ...
        'verificationIdentity': build_verification_identity(
            ...
            hardware_identity={'boardId': str(args.board_id or '').strip(), 'boardClass': str(args.board_class or '').strip()},
            firmware_identity={'firmwareVersion': str(args.firmware_version or '').strip(), 'firmwareSha256': str(args.firmware_sha256 or '').strip()},
        ),
