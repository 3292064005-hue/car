import { z } from 'zod';
        ...
        export const RUNTIME_PARAM_FIELD_SCOPES = {
  "maxLinearSpeed": "backend_authoritative",
  "maxAngularSpeed": "backend_authoritative",
  "teleopStep": "frontend_local",
  "trackOffsetDeadband": "backend_authoritative",
  "lowPowerThreshold": "backend_authoritative",
  "reconnectTimeoutMs": "frontend_local"
} as const;
        export const RUNTIME_PARAM_BACKEND_AUTHORITATIVE_KEYS = ["maxLinearSpeed", "maxAngularSpeed", "trackOffsetDeadband", "lowPowerThreshold"] as const;
        export const RUNTIME_PARAM_FRONTEND_LOCAL_KEYS = ["teleopStep", "reconnectTimeoutMs"] as const;
