export const PRODUCT_INTERFACE_CONTRACT = {
  "contractVersion": "1.0.0",
  "protocolFamily": "inspection_robot.operator_api.v1",
  "transportContract": {
  ...
  "httpEndpoints": {
    ...
    "productInterface": "/api/v1/product-interface",
  ...
  "singleRobotPolicy": {
    "fleetAdapterBoundary": {
      "contractVersion": "1.1.0",
      "status": "disabled_by_default",
      "enabled": false,
      "requestedEnabled": false,
      "activationDecision": "disabled",
      "policyReason": "disabled_by_default",
      "adapterFamily": "disabled",
      "singleRobotAuthority": true,
      "singleRobotAuthorityOwners": [
        "robot_decision",
        "robot_navigation"
      ],
      "taskIngressTopic": "/robot/fleet_adapter/tasks",
      "statusTopic": "/robot/fleet_adapter/status",
      "acceptedTaskKinds": [
        "patrol_route"
      ],
  ...
  "operatorNotes": [
    ...
    "当前产品发布面仅支持单机任务编排；fleet/multi-robot 保持禁用。"
        ...
        export type GeneratedProductInterfaceContract = typeof PRODUCT_INTERFACE_CONTRACT;
