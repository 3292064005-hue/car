...
def generate_launch_description() -> LaunchDescription:
    ...
    nodes = [
        ...
        Node(package='robot_decision', executable='decision_node', name='robot_decision', parameters=[config_path('decision.yaml'), {'patrol_config_path': config_path('patrol.yaml'), 'strict_patrol_config': LaunchConfiguration('strict_patrol_config'), 'allow_default_patrol_fallback': LaunchConfiguration('allow_default_patrol_fallback')}], arguments=['--ros-args', '--log-level', log_level], output='screen'),
