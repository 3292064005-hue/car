...
def generate_launch_description() -> LaunchDescription:
    ...
    nodes = [
        ...
        Node(package='robot_decision', executable='decision_node', name='robot_decision', parameters=[config_path('decision.yaml'), {'mission_catalog_path': config_path('mission_catalog.yaml')}], arguments=['--ros-args', '--log-level', log_level], output='screen'),
        ...
        Node(package=LaunchConfiguration('navigation_runtime_package'), executable=LaunchConfiguration('navigation_runtime_executable'), name=LaunchConfiguration('navigation_runtime_node_name'), parameters=[LaunchConfiguration('navigation_config_path'), {'route_plan_path': LaunchConfiguration('waypoint_config_path'), 'provider_name': LaunchConfiguration('navigation_runtime_provider_name')}], arguments=['--ros-args', '--log-level', log_level], output='screen', condition=IfCondition(LaunchConfiguration('enable_navigation'))),
        Node(package=LaunchConfiguration('hardware_runtime_package'), executable=LaunchConfiguration('hardware_runtime_executable'), name=LaunchConfiguration('hardware_runtime_node_name'), parameters=[LaunchConfiguration('hardware_interface_config_path'), {'description_path': LaunchConfiguration('description_path'), 'hardware_interface_config_path': LaunchConfiguration('hardware_interface_config_path'), 'bridge_config_path': config_path('bridge.yaml'), 'host': LaunchConfiguration('bridge_host'), 'port': LaunchConfiguration('bridge_port')}], arguments=['--ros-args', '--log-level', log_level], output='screen', condition=IfCondition(LaunchConfiguration('enable_hardware_interface'))),
        ExecuteProcess(
