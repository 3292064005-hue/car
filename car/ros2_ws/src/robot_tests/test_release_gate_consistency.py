...
def test_release_gate_common_checks_package_clean_source_release() -> None:
    script = (REPO_ROOT / 'scripts' / 'release_gate_common.sh').read_text(encoding='utf-8')
    assert 'scripts/package_source_release.py' in script
