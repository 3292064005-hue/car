...
LANES: tuple[GateLane, ...] = (
    GateLane(
        ...
        required_markers=(
            ...
            'npm --prefix robot_frontend exec playwright install --with-deps chromium',
            'Frontend E2E',
            'npm --prefix robot_frontend run test:e2e:ci',
        ),
    ...
    GateLane(
        ...
        entrypoint='./scripts/run_release_verification.sh --with-integrated-frontend-smoke',
        required_markers=(
            'integrated_frontend_bridge_smoke:',
            'Integrated frontend + web bridge smoke',
            'python3 scripts/run_integrated_frontend_bridge_smoke.py',
        ),
