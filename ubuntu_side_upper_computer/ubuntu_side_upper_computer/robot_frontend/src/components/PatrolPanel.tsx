  ...
  return (
    <SectionCard title="巡检任务">
      ...
      <div className="inline-actions">
        <button className="primary-btn" disabled={ui.demoReadonly} onClick={() => robotBridge.send('start_patrol', { source: 'frontend' }, '开始巡检任务')}>开始巡检</button>
        <button className="ghost-btn" disabled={ui.demoReadonly} onClick={() => robotBridge.send('pause_patrol', { source: 'frontend' }, '暂停巡检任务')}>暂停巡检</button>
        <button className="danger-btn" disabled={ui.demoReadonly} onClick={() => robotBridge.send('stop_patrol', { source: 'frontend' }, '停止巡检任务')}>停止巡检</button>
      </div>
